...
### Examples of common regularization variants
 ...
 - Elastic-net regularization: this regularization method uses a combination of the previous two penalty functions : $$\text{Pen}(\beta) = $$

 - these functions have different properties (L1 vs L2)
