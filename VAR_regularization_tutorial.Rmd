...
Before discussing regularization, we briefly reconsider maximum likelihood estimation. Suppose we have a dataset of observations of independent variables $x_1$, $x_2$ and a response variable $y$. 
